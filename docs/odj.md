...
## Using with ADS
- Provide the blob path to the wizard (or copy it into `X:\Deploy\ODJ\odjblob.txt` before running WinPE). The Workbench can help lay out payloads and blobs before you build media.
